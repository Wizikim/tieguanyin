...
<script type="text/javascript">
	var Public = "/mycms/upload/Public/Home/Default";
</script>
<script  type="text/javascript" src="/mycms/upload/Public/Home/Default/js/jquery_min.js"></script>
<script  type="text/javascript" src="/mycms/upload/Public/Home/Default/js/index.js"></script>
<script  type="text/javascript" src="/mycms/upload/Public/Home/Default/js/topdb.js"></script>
<!--[if IE 6]><script src="/mycms/upload/Public/Home/Default/js/png.js"></script><![endif]-->
<link rel="stylesheet" type="text/css" href="/mycms/upload/Public/Home/Default/css/common.css" media="all">
<link rel="stylesheet" type="text/css" href="/mycms/upload/Public/Home/Default/css/index.css" media="all">
</head>
<body>
...
<!-- 页头 -->
﻿<!--[if IE 6]>
<script src="/mycms/upload/Public/Home/Default/js/DD_belatedPNG_0.0.8a-min.js" language="javascript" type="text/javascript"></script>
<script>
...
<?php if(is_array($blist)): $i = 0; $__LIST__ = $blist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v['column_ifimg']): if($v['column_images']): ?><div style="width:100%; height:180px;background:url(/mycms/upload/Uploads/<?php echo ($v["column_images"]); ?>) no-repeat center top; margin-bottom:5px; margin-top:-20px;">&nbsp;</div><?php endif; ?>
...
<div class="quan_hd">
					<p class="crumb">
						<em></em> <a href="/mycms/upload/index.php">网站首页</a> &gt;
						<?php if($ifid==not): ?><a href="/mycms/upload/index.php/Guestbook">在线留言</a>
						<?php else: ?>
...
<div class="tuzikf">
    ...
    <div class="slide_box" style="display:none;">
    	<h2><img src="/mycms/upload/Public/Home/Default/images/slide_box.jpg" /></h2>
        <p><a title="点击这里给我发消息" href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo ($kefu_qq); ?>&amp;site=www.cactussoft.cn&amp;menu=yes" target="_blank"><img src="/mycms/upload/Public/Home/Default/images/qqweb.gif"></a></p>
        <p>
        	<img src="/mycms/upload/Public/Home/Default/images/qrcode.jpg" class="weixin"  width="120" height="120"/><br />
        	<b>客户服务热线</b><br />
        	<?php echo ($kefu_tel); ?>
        </p>
        <span><a href="/mycms/upload/index.php/guestbook">给我们留言</a></span>
    </div>
</div>
<script>
$(function(){
