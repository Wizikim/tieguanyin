...
<link href="/mycms/upload/App/Manage/View/Default/css/frame.css" rel="stylesheet" type="text/css" />
...
<div class="top_logo"></div>
	 ...
	 <div class="top_link">
      <ul>
        ...
        <li id="i_home"><a href="/mycms/upload/index.php" target="_blank">首页</a></li> 
        <li id="i_help"><a href="http://www.tuzicms.com/" target="_blank">帮助</a></li>    
        <li id="i_exit"><a href="/mycms/upload/index.php/manage/admin/login_out" target="_top">退出</a></li>		
      </ul>
    </div>
</div>
<!-- header end -->
...
<div id="items_banner">
	<dl id="dl_items_1_1">
		...
		<dd>
		<ul>
		<li><a href="/mycms/upload/index.php/<?php echo ($module); ?>/Banner/index" target="main">栏目广告</a></li>
		</ul>
		</dd>
	</dl>
	<dl id="dl_items_1_1">
