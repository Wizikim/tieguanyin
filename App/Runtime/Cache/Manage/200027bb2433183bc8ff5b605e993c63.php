...
<LINK rel=stylesheet type=text/css href="/mycms/upload/App/Manage/View/Default/css/login.css">
...
<script type="text/javascript" src="/mycms/upload/App/Manage/View/Default/js/jquery-1.7.2.min.js"></script>
<BODY id="login">
<div style="background:#CCCCCC">
<FORM id=loginForm onSubmit="return check(this)" method="post" action="/mycms/upload/index.php/manage/login/do_login">
...
<LABEL><SPAN></SPAN><span style="margin-left:70px; margin-top:-10px;"><img src='/mycms/upload/index.php/Manage/Verify/code?w=200&h=32' onclick='this.src=this.src+"?"+Math.randon'/></span></LABEL>
