...
<script src="/mycms/upload/App/Manage/View/Default/js/common.js" type="text/javascript"></script>
 <script type="text/javascript">
  function clear_del()
  {
   if(confirm("确定要删除数据吗？"))
   {
	subform('/mycms/upload/index.php/manage/advert/delall');
   }
  }
 </script>
...
<div class="main">
    ...
    <div class="operate">
        <div class="left">
            <input type="button" onclick="window.open('/mycms/upload/index.php/manage/advert/add/nav/<?php echo ($nav); ?>','main')" target="main" class="btn_blue" value="添加">
			<input type="button" onclick="window.open('/mycms/upload/index.php/manage/advert/addsort','main')" target="main" class="btn_blue" value="添加分类">
			<input type="button" onclick="window.open('/mycms/upload/index.php/manage/advert/adnav','main')" target="main" class="btn_blue" value="分类管理">
        ...
        <?php if(ACTION_NAME == "index"): ?><div class="left_pad">
            <form method="post" action="/mycms/upload/index.php/manage/advert/search">
    ...
    <div class="list">    
    <form action="/mycms/upload/index.php/manage/advert/sortcate/nav/<?php echo ($nav); ?>" method="post" id="form_do" name="form_do">
        <table width="100%">
            <tr>
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr style="height:95px;">
				...
				<td><a href="/mycms/upload/Uploads/<?php echo ($v["advert_image"]); ?>" target="_blank"><img src="/mycms/upload/Uploads/<?php echo ($v["advert_image"]); ?>" width="150px" height="50px" border="0" /></a></td>
                ...
                <td>
                    <a href="/mycms/upload/index.php/manage/advert/edit/id/<?php echo ($v["id"]); ?>">修改</a>
                    <a href="/mycms/upload/index.php/manage/advert/del/id/<?php echo ($v["id"]); ?>" onclick="return confirm('是否确定删除?')">删除</a>
				</td>
